...
minus = Button(f2, padx = 16,pady = 16, bd = 8, fg="black", font=('arial',20,'bold'),
...
txtReference = Entry(f1, font=('arial',20,'bold'), textvariable = rand , bd = 10, insertwidth = 4,
                    bg ="powder blue", justify = "right")
txtReference.grid(row = 0, column = 1)

lblFries = Label(f1, font=('arial',20,'bold'), text = "Large Fries", bd = 16, anchor ="w" )
lblFries.grid(row = 1, column = 0)
txtFries = Entry(f1, font=('arial',20,'bold'), textvariable = Fries , bd = 10, insertwidth = 4,
                    bg ="powder blue", justify = "right")
txtFries.grid(row = 1, column = 1)

lblBurger = Label(f1, font=('arial',20,'bold'), text = "Burger Meal", bd = 16, anchor ="w" )
lblBurger.grid(row = 2, column = 0)
txtBurger = Entry(f1, font=('arial',20,'bold'), textvariable = Burger , bd = 10, insertwidth = 4,
                    bg ="powder blue", justify = "right")
txtBurger.grid(row = 2, column = 1)

lblFilet = Label(f1, font=('arial',20,'bold'), text = "Filet_o_Meal", bd = 16, anchor ="w" )
lblFilet.grid(row = 3, column = 0)
txtFilet = Entry(f1, font=('arial',20,'bold'), textvariable = Filet , bd = 10, insertwidth = 4,
                    bg ="powder blue", justify = "right")
txtFilet.grid(row = 3, column = 1)

lblChicken = Label(f1, font=('arial',20,'bold'), text = "Chicken Meal", bd = 16, anchor ="w" )
lblChicken.grid(row = 4, column = 0)
txtChicken = Entry(f1, font=('arial',20,'bold'), textvariable = Chicken_Burger , bd = 10, insertwidth = 4,
                    bg ="powder blue", justify = "right")
txtChicken.grid(row = 4, column = 1)

lblCheese = Label(f1, font=('arial',20,'bold'), text = "Cheese Meal", bd = 16, anchor ="w" )
lblCheese.grid(row = 5, column = 0)
txtCheese = Entry(f1, font=('arial',20,'bold'), textvariable = Cheese_Burger , bd = 10, insertwidth = 4,
                    bg ="powder blue", justify = "right")
...
txtDrinks = Entry(f1, font=('arial',20,'bold'), textvariable = Drinks , bd = 10, insertwidth = 4,
                    bg ="#ffffff", justify = "right")
txtDrinks.grid(row = 0, column = 3)

lblCost = Label(f1, font=('arial',20,'bold'), text = "Cost of Meal", bd = 16, anchor ="w" )
lblCost.grid(row = 1, column = 2)
txtCost = Entry(f1, font=('arial',20,'bold'), textvariable = Cost , bd = 10, insertwidth = 4,
                    bg ="#ffffff", justify = "right")
txtCost.grid(row = 1, column = 3)

lblService = Label(f1, font=('arial',20,'bold'), text = "Service Charge", bd = 16, anchor ="w" )
lblService.grid(row = 2, column = 2)
txtService = Entry(f1, font=('arial',20,'bold'), textvariable = Service_Charge , bd = 10, insertwidth = 4,
                    bg ="#ffffff", justify = "right")
txtService.grid(row = 2, column = 3)

lblStateTax = Label(f1, font=('arial',20,'bold'), text = "State Tax", bd = 16, anchor ="w" )
lblStateTax.grid(row = 3, column = 2)
txtStateTax = Entry(f1, font=('arial',20,'bold'), textvariable = Tax , bd = 10, insertwidth = 4,
                    bg ="#ffffff", justify = "right")
txtStateTax.grid(row = 3, column = 3)

lblSubTotal = Label(f1, font=('arial',20,'bold'), text = "Sub Total", bd = 16, anchor ="w" )
lblSubTotal.grid(row = 4, column = 2)
txtSubTotal = Entry(f1, font=('arial',20,'bold'), textvariable = SubTotal , bd = 10, insertwidth = 4,
                    bg ="#ffffff", justify = "right")
txtSubTotal.grid(row = 4, column = 3)

lblTotalCost = Label(f1, font=('arial',20,'bold'), text = "Total Cost", bd = 16, anchor ="w" )
lblTotalCost.grid(row = 5, column = 2)
txtTotalCost = Entry(f1, font=('arial',20,'bold'), textvariable = Total , bd = 10, insertwidth = 4,
                    bg ="#ffffff", justify = "right")
